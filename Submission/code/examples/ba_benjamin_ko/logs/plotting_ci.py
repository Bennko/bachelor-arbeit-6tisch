...
experiment_number = 2 # Specify the experiment number
experiment_number_sens = 21
...
sns.lineplot(x='Cell Number', y='Time', hue='Type', style='Experiment', data=plot_df, errorbar=('ci', 95), marker='o')
